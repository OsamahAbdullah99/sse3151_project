...
class RegisterWidgetPAC extends StatefulWidget {
  const RegisterWidgetPAC({Key? key}) : super(key: key);

  @override
  _RegisterWidgetPACState createState() => _RegisterWidgetPACState();
}

class _RegisterWidgetPACState extends State<RegisterWidgetPAC> {
  ...
  Future signUp() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'role': 'Academic Advisor (PA) Coordinator',
        'image':
      ...
      await FirebaseChatCore.instance.createUserInFirestore(
        types.User(
          ...
          imageUrl:
              'https://firebasestorage.googleapis.com/v0/b/padvisor-45b73.appspot.com/o/def_profIcon.png?alt=media&token=12132e6a-7c3d-4424-a36a-6e1334dc799b?u=$id',
        ),
      );
      print('Successfully register a PA Coordinator');
