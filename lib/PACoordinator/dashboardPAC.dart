...
class dashboardPAC extends StatelessWidget {
  const dashboardPAC({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('postTo', isEqualTo: 'Academic Advisor (PA) Coordinator')
            .snapshots(),
        initialData: null,
              ...
              appBar: AppBar(
                ...
                actions: [
                  PopupMenuButton<MenuItem>(
                    ...
                    itemBuilder: (context) => [
                      ...MenuLists.itemPACLists.map(buildItem).toList(),
                      PopupMenuDivider(),
    ...
    switch (item) {
      case MenuLists.itemProfile:
        Navigator.of(context).push(
          MaterialPageRoute(builder: (context) => PAC_Profile()),
        );
        break;
      case MenuLists.itemPA:
        Navigator.of(context).push(
          MaterialPageRoute(builder: (context) => paList()),
        );
        break;
      ...
      case MenuLists.itemLogOut:
        ...
        Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(builder: (context) => LoginWidgetPAC()),
          (route) => false,
        );
        break;
      default:
