...
class LoginWidgetPAC extends StatefulWidget {
  const LoginWidgetPAC({Key? key}) : super(key: key);

  @override
  _LoginWidgetPACState createState() => _LoginWidgetPACState();
}

class _LoginWidgetPACState extends State<LoginWidgetPAC> {
                ...
                child: GestureDetector(
                  onTap: () => {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RegisterWidgetPAC()))
                  },
                  child: RichText(
                    text: TextSpan(
  ...
  Future signIn() async {
    try {
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => dashboardPAC()));
