import 'package:SSE3151_project/HOD/addPAC.dart';
...
class pacList extends StatefulWidget {
  const pacList({Key? key}) : super(key: key);

  @override
  _pacListState createState() => _pacListState();
}

final user = FirebaseAuth.instance.currentUser;

class _pacListState extends State<pacList> {
  String? wsLink;
  String? wcLink;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('PA Coordinator List'),
        centerTitle: true,
                        ...
                        endActionPane:
                          ...
                          SlidableAction(
                            onPressed: (BuildContext context) async {
                              ...
                              QuerySnapshot upmID_Stream = await pacInfo
                        ...
                        child: ListTile(
                          ...
                          onTap: () async {
                            ...
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => showPACProfile(
                                    upm_id,
                                    fullName,
                                    faculty,
                                    dept,
  ...
  //start of developing for PA Coordinator's profile
  Future getPACProfile(
      String upm_id,
      String fullName,
      String faculty,
      String dept,
  ...
  showPACProfile(String upm_id, String fullName, String faculty, String dept,
                  ...
                  OutlinedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    sendEmailtoPACPage(upm_id, email)));
                      },
                      child: Card(
                        elevation: 10,
                        shape: RoundedRectangleBorder(
  ...
  //start of developing for sending email to respective PAC
  Future getPACEmail(String upm_id, String email) async {
    final db = await FirebaseFirestore.instance
        .collection('PAC_HOD')
        .doc(user?.uid)
        .collection('PAC')
  ...
  sendEmailtoPACPage(String upm_id, String email) {
    getPACEmail(upm_id, email);
